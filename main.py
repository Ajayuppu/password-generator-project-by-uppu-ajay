...
lbl_instructions = Label(Bot, width=width, font=('sans serif', 12, 'bold'), text="Press (ctrl+v) from the keyboard in notepaed password will be copied and pasted.", bd=1, relief=SOLID)
